...
- main:
  ...
  - text: "* Scenario Name"
  - textbox "* Scenario Name": Test Scenario
  - text: Description
  - textbox "Description": Test scenario to verify fix
  - text: "* Start Year"
  - spinbutton "* Start Year": "2025"
  - text: "* Start Month"
  - combobox "* Start Month"
  - text: 1 * End Year
  - spinbutton "* End Year": "2026"
  - text: "* End Month"
  - combobox "* End Month"
  - text: 12 Office Scope
  - radio "Group (all offices)"
  - text: Group (all offices)
  - radio "Individual Offices" [checked]
  - text: Individual Offices * Select Offices Stockholm
  - combobox "* Select Offices"
  - button "Back"
