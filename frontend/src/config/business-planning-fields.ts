...
const FIELD_DEFINITIONS: FieldMetadata[] = [
  ...
  },
  {
    ...
    color: 'text-green-600',
    bgColor: 'bg-green-50 dark:bg-green-950/20',
    description: 'Calculated net sales (price × utr × billable_hours × fte)',
    valueType: 'currency',
    currencyCode: 'EUR',
    precision: 0,
    formula: 'price × utr × billable_hours × fte',
    dependencies: ['price', 'utr', 'billable_hours', 'fte'],
    applicableRoles: ['Consultant'],
    isEditable: false,
    showInSummary: true,
    aggregateMethod: 'sum',
  ...
  },
  {
    ...
    formula: 'office_rent + travel_expenses + it_services + training_education + external_services',
    dependencies: ['office_rent', 'travel_expenses', 'it_services', 'training_education', 'external_services'],
    isEditable: false,
    showInSummary: true,
    aggregateMethod: 'sum',
    contributesToCosts: true,
    ...
    subsections: [
      {
        ...
        order: 1,
        fields: ['price', 'utr', 'monthly_hours', 'absence', 'billable_hours'],
    ...
    subsections: [
      {
        ...
        description: 'Salary, benefits, and people costs',
        order: 1,
        fields: ['base_salary', 'social_security', 'pension', 'bonus_provision', 'total_compensation', 'total_people_costs'],
        roleOrganization: 'all',
        levelOrganization: 'all',
        isCollapsible: true,
        defaultExpanded: true,
      ...
      },
      {
        ...
        description: 'Office rent, utilities, and facilities',
        order: 2,
        fields: ['office_rent'],
        roleOrganization: 'all',
        levelOrganization: 'all',
      ...
      },
      {
        ...
        description: 'Travel, IT, training, and services',
        order: 3,
        fields: ['travel_expenses', 'it_services', 'training_education', 'external_services'],
        roleOrganization: 'all',
        levelOrganization: 'all',
        isCollapsible: true,
        defaultExpanded: true,
